                ...
                <div class="col-lg-12 col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="" class="form-sample" method="POST" id="UserdaftarAkun">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                            <select class="form-select" name="Userwilayah" id="Userwilayah" >
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                            <select name="GetAreaKerja" id="GetAreaKerja" class="form-select">
