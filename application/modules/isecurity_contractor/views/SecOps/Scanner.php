		...
		<div class="row mb-2">
			<div class="col-sm-6">
				<h4 class="info-box-text">Selamat Datang <?= $user->nama?></h4>
       			 <h6 class="info-box-text">Ini Adalah Menu Melakukan Scanner Kendaraan <span class="text-primary"><?= $user->area_kerja?>!</span></h6>
			</div>
		</div>
	</div>
</section>
                                ...
                                <form action="" class="form-sample" method="POST" id="PostKendaraan">
                                   <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <input type="text" hidden class="form-control" id="noBarcodeKendaraan" name="noBarcodeKendaraan"/>
