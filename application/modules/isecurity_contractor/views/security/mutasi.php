                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="npk" class="form-control"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="" class="col-sm-3 col-form-label">Nomor KTA</label>
                                            <div class="col-sm-9">
                                                <input type="text" id="no_kta" class="form-control"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="" class="col-sm-3 col-form-label">Masa Aktif KTA</label>
                                            <div class="col-sm-9">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="" class="col-sm-3 col-form-label">Nomor Telephone</label>
                                            <div class="col-sm-9">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="" class="col-sm-3 col-form-label">Nomor Darurat</label>
                                            <div class="col-sm-9">
                                                <input type="text" id="no_emergency" class="form-control"/>
                                            </div>
                                        </div>
                                    </div>
                                    
                                    <p class="card-description">Aktif Bekerja</p>
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="" class="col-sm-3 col-form-label">Masuk ADM</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control"/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="" class="col-sm-3 col-form-label">Masuk SIGAP</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control"/>
                                            </div>
                                        </div>
                                    ...
                                    <hr>
                                    <p class="card-description">Personal Biodata</p>
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="" class="col-sm-3 col-form-label">Indeks Massa Tubuh</label>
                                            <div class="col-sm-9">
                                    ...
                                    <hr>
                                    <p class="card-description">Alamat Sesuai Domisili</p>
                                    <div class="col-md-6">
                                        <div class="form-group row">
