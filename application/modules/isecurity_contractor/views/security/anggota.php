            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">Ini Adalah Menu PIC Wilayah <span class="text-primary"><?= $user->wilayah?>!</span></h6>
                </div>
                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body">
                     ...
                     <a href="<?php echo base_url('agt/wil/').$this->murry->enkrip($user->wilayah).'' ;?>" class="text-white" style="text-decoration:none;"> <p class="fs-30 mb-2"><?php echo $wilayah ?> </p></a>
                    </div>
                  </div>
                </div>
                <?php 
                ...
                <div class="col-md-6 stretch-card transparent">
                  <div class="card card-light-danger">
                    <div class="card-body">
                      ...
                      <a href="<?php echo base_url('exprt')?>" style="text-decoration: none;" class="text-white fs-30 mb-2" >
                      <p class="fs-20 mb-0">Data Excel</p>
                      </a>
                    </div>
                  </div>
                </div>
                        ...
                        <div class="row">
                          <div class="col-md-12 col-xl-3 d-flex flex-column justify-content-start">
                            ...
                            <p class="card-title">Total Anggota </p>
                              <h1 class="text-primary"><?= $wilayah?> MP</h1>
                          ...
                          <div class="col-md-12 col-xl-9">
                            <div class="row">
                              ...
                              <div class="col-md-6 mt-3" >
                                  <div class="chart-container" style="position: justify; height:350px; width:350px; margin-left: 30px;">
