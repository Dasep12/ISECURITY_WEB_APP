      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="updateFotoAnggota"  action="" enctype="multipart/form-data">
            <div class="mb-5">
            <input type="hidden" class="form-control"  name="id" id="id" value="<?=$profile->id_biodata ?>"> 
            <label for="Image" class="form-label">Foto</label>
            <input class="form-control" type="file" id="file" name="file" onchange="return validasifileakun()">
            </div>
          </div>
...
<div class="modal fade" id="UpdateBiodata" tabindex="-1" aria-labelledby="UpdateBiodata" aria-hidden="true">
      <div class="modal-dialog modal-lg">     
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="UpdateBiodata">Update Biodata</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
