    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <form method="post" action="<?= base_url('analitic/crime/Crime/upload_data') ?>" onsubmit="return cekExe()" enctype="multipart/form-data">
...
<script>
    ...
    let table = $('#crime_data').DataTable({
        ...
        pageLength: 10,
        ajax: {
            url: "<?= base_url('analitic/crime/Crime/getList_crime') ?>",
            dataSrc: '',
        },
        columns: [{
            data: 'kota'
