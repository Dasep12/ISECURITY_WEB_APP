                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card cardIn2">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-5 pt-4 text-center d-none">
                                        <div class="row">
                                            <?php
                                            echo '
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            ...
                                            <div class="col-5 mx-auto py-4 px-5 text-center">
...
<script type="text/javascript">
    ...
    document.getElementById("grapSoi").onclick = function(evt) {
        ...
        if(firstPoint)
        {
            ...
            $.ajax({
                url: '<?= site_url('analitic/srs/dashboard/grap_trend_soi'); ?>',
                type: 'POST',
                data: {
                    area_fil: area,
                    year_fil: year,
                ...
                success: function(res) {
                    ...
                    document.getElementById("trendGrapSoi").onclick = function(evt) {
                        ...
                        if(firstPoint)
                        {
                            ...
                            console.log(data)
                            $.ajax({
                                url: '<?= site_url('analitic/srs/dashboard/grap_risksource_soi'); ?>',
                                type: 'POST',
                                data: {
                                    area_fil: area,
                                    year_fil: year,
