                            ...
                            <div class="card">
                                ...
                                <div class="card-body px-lg-4">
                                    ...
                                    <fieldset class="border p-4 mt-2 mb-4">
                                        ...
                                        <legend class="w-auto h5">Matriks Category</legend>
                                        <!-- Media -->
                                        <div class="form-row mb-4">
                                            <div class="form-group col-3">
                                        ...
                                        <div class="form-row mb-4">
                                            <div class="form-group col-3">
                                                ...
                                                <input id="categoryLevel" class="form-control" type="text" name="category_level" readonly required>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset class="border p-4 mt-2 mb-4">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group">
                                                <input id="riskLevel" class="form-control text-center" type="text" name="risk_level" readonly required>
                                            </div>
                                        </div>
                                    </fieldset>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $('#mediaIssue ,#attitude ,#regional ,#legalitas ,#legalitasSub1 ,#format').change(function (e) {
            ...
            {
                var riskLevel = (categoryLevel * 0.2) + (impactLevel * 0.8);
