                                    ...
                                    <fieldset class="border p-4 mt-2 mb-4">
                                        ...
                                        <div class="form-row mb-4">
                                            <div class="form-group col-3">
                                                ...
                                                <input id="LevelriskTreat" class="form-control" type="text" name="LevelriskTreat" readonly required>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset class="border p-4 mt-2 mb-4">
                                        ...
                                        <div class="form-row ml-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="vulnerability_level" id="vulnerabilityLevel" readonly class="form-control">
                                            </div>
                                        </div>
                                    </fieldset>
