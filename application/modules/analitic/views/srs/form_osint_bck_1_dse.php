                ...
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <?php if (is_access_privilege($this->module_code, 'crt')) { ?>
                            <button class="nav-link active" id="nav-home-tab" data-toggle="tab" data-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Input Data
                            </button>
                        <?php } ?>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body px-lg-4">
                                    ...
                                    <div class="form-row mb-4 ">
                                        ...
                                        <div class="form-group col-3" id="column12" style="display: none;">
