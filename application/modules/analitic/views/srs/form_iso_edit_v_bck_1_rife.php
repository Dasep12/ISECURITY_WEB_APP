            ...
            <div class="col-12">
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="card">
                            <?= form_open_multipart('analitic/srs/internal_source/update'); ?>
                                        ...
                                        <div class="field-wrapper">
                                            <div class="mb-1">
                                                ...
                                                <?php 
                                                    ...
                                                    // if($data_edit->attach_file_1 !== NULL) {
                                                    //     echo '
                                                    //         <li class="list-group-item attached-files d-flex justify-content-between">
                                                    //         <a class="" href="'.site_url('uploads/srs_bi/internal_source/'.$data_edit->attach_file_1).'" target="_blank">FILE 1</a>
                                                    //         <input type="text" name="attached[1]" value="'.$data_edit->attach_file_1.'" hidden>
                                                    //         <button type="button" class="btn remove-attached text-danger" data-field-file="attach_file_1" data-toggle="modal" data-target="#deleteModal"><i class="fa fa-trash"></i></button>
                                                    //         </li>';
                                                    // }
                                                    // if($data_edit->attach_file_2 !== NULL) {
                                                    //     echo '
                                                    //         <li class="list-group-item attached-files d-flex align-items-center justify-content-between">
                                                    //         <a class="d-block" href="'.site_url('uploads/srs_bi/internal_source/'.$data_edit->attach_file_2).'" target="_blank">FILE 2</a>
                                                    //         <input type="text" name="attached[2]" value="'.$data_edit->attach_file_2.'" hidden>
                                                    //         <button id="attached-file-2" type="button" class="btn remove-attached text-danger" data-field-file="attach_file_2" data-toggle="modal" data-target="#deleteModal"><i class="fa fa-trash"></i></button>
                                                    //         </li>';
                                                    // }
                                                ?>
                                                </ul>
    ...
    $( document ).ready(function() {
        ...
        $('#btn-dlt-attc').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?= site_url('analitic/srs/internal_source/delete_attached'); ?>",
                dataType:'json',
