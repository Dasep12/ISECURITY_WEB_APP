            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="card" style="height: 390px;">
                            <div class="card-body">
                                <h5 class="text-center">Risk Source</h5>
                                <div class="row">
                                    <div class="col-lg-12 mb-3">
                                        <h6 class="text-white" style="font-size: 14px">Internal</h6>
                                        <canvas id="intSource"></canvas>
                                    </div>
                                    <div class="col-lg-12">
                                        <h6 class="text-white" style="font-size: 14px">External</h6>
        ...
        $("#areaFilter, #yearFilter, #monthFilter").change(function(e) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    console.log(json.data_index[0].max_iso+' '+json.data_soi[0].avg_soi)
                    // SOI //
                    var dataSrs = [{
                        r: 8,
