        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12 mb-4">
                                ...
                                <div id="legend-container-barRiskSourceInt">
                                    <canvas id="barRiskSourceInt"></canvas>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <h5>External Source</h5>
                                <div id="legend-container-barRiskSourceExt">
            ...
            <div class="col-lg-3">
                <div class="card" style="height:650px;">
                    ...
                    <div class="card-body text-center">
                        <div id="legend-container-barRisk">
            ...
            <div class="col-lg-3">
                <div class="card" style="height:650px;">
                    ...
                    <div class="card-body text-center">
                        <div id="legend-container-barMedia">
...
<script type="text/javascript">
    const getOrCreateLegendList = (chart, id) => {
      ...
      if (!listContainer) {
        ...
        listContainer.style.padding = '20px 0 0';
