...
class Dashboard extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $grap_target_assets = $this->M_dashboard->grap_target_assets()->result_array();
    ...
    public function grap_detail_risk_source()
    {
        ...
        $res_riSo_month_sub2 = $this->M_dashboard->grap_detail_risksource('risksource_sub2_id')->result_array();
    ...
    public function grap_detail_assets()
    {
        ...
        $res_assets_sub1_month = $this->M_dashboard->grap_detail_assets('assets_sub1_id')->result_array();
        // TARGET ASSETS SUB 1
        ...
        $res_assets_sub2_month = $this->M_dashboard->grap_detail_assets('assets_sub2_id')->result_array();
    ...
    public function grap_detail_risk()
    {
        ...
        $res_risk_sub1 = $this->M_dashboard->grap_detail_risk_sub('risk_sub1_id')->result_array();
        $res_risk_sub1_month = $this->M_dashboard->grap_detail_risk('risk_sub1_id')->result_array();
        $res_risk_sub2 = $this->M_dashboard->grap_detail_risk_sub('risk_sub2_id')->result_array();
        $res_risk_sub2_month = $this->M_dashboard->grap_detail_risk('risk_sub2_id')->result_array();
    ...
    {
        // TREND YEAR MODEL
        $res_trend_year = $this->M_dashboard->grap_trend_soi()->result_array();
    ...
    {
        $grap_risk_source = $this->M_dashboard->grap_risksource_soi()->result_array();
