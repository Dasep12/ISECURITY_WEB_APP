...
class M_osint extends CI_Model
{
    ...
    private function _get_datatables_query()
    {
        ...
        $this->osidb->join('admisecosint_sub2_header_data ashd1', 'ashd1.id = t.sub1_media_id', 'inner');
        $this->osidb->join('admisecosint_sub1_header_data ashd2', 'ashd2.id = t.sub_media_id', 'inner');
        $this->osidb->join('admisecosint_sub_header_data ashd3', 'ashd3.sub_id = t.risk_id', 'inner');
    ...
    public function get_detail()
    {
        $id = $this->input->post("id");
        // $id = 69;
        $this->osidb->select('tr.id,tr.activity_name , tr.date , asu.title as plant , lev.level as sdm_level , lev2.level as reputasi_level , tr.created_by , ashd.name as media , ashd1.name as jenis_media ');
