        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="">Tambah Kategori Objek</a></li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card4">
                    ...
                    <form onsubmit="return cek()" action="<?= base_url('Mst_Kategori_Object/input') ?>" method="post" id="inputEvent">
