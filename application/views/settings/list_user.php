    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <?php endif ?>
                <a href="<?= base_url('Setting/Pengguna/register') ?>" class="mb-2 btn btn-sm btn-primary" data-backdrop="static" data-keyboard="false">
                            ...
                            <tbody>
                                ...
                                foreach ($user->result() as $zn) : ?>
                                    <tr>
                                        ...
                                        <td><?= strtoupper($zn->patrol_group) == "" ? 'NON-GROUP' : strtoupper($zn->patrol_group) ?></td>
                                        <td>
                                            <?php
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= base_url('Setting/Pengguna/hapus/' . $zn->npk) ?>" onclick="return confirm('Yakin Hapus ?')" class='text-danger' title="hapus data"><i class="fa fa-trash"></i></a>
                                            ...
                                            <a href="<?= base_url('Setting/Pengguna/edit?user_id=' . $zn->npk) ?>" class='text-success  ml-2 ' title="edit data" data-backdrop="static" data-keyboard="false" data-id="<?= $zn->npk ?>"><i class="fa fa-edit"></i></a>

                                            <a href="<?= base_url('Setting/Pengguna/edit_pwd?user_id=' . $zn->npk) ?>" class="text-warning  ml-2 " title="rubah password"><i class="fas fa-lock"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
    ...
    <div class="modal fade" id="edit-password" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="post" onsubmit="return cekpassword()" action="<?= base_url('Setting/Pengguna/resetPasword') ?>">
                    <div class="modal-body">
                        <div class="form-group">
