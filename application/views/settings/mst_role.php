        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?= base_url('Setting/MasterRole/list_role') ?>">Master</a></li>
                    <li class="breadcrumb-item"><a href="<?= base_url('Setting/MasterRole/list_role') ?>">Role User</a></li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="<?= base_url('Setting/MasterRole/form_add') ?>" class="btn btn-sm btn-primary" data-backdrop="static">
                                ...
                                foreach ($role->result() as $zn) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= base_url('Setting/MasterRole/hapus/' . $zn->role_id) ?>" onclick="return confirm('Yakin Hapus ?')" class='text-danger '><i class="fas fa-trash"></i></a>
                                            ...
                                            <a href="<?= base_url('Setting/MasterRole/edit?role_id=' . $zn->role_id) ?>" class='text-success  ml-3 '><i class="fa fa-edit"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
