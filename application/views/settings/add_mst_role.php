        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?= base_url('Setting/MasterRole/') ?>">Master</a></li>
                    <li class="breadcrumb-item"><a href="<?= base_url('Setting/MasterRole/') ?>">Role User</a></li>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <form onsubmit="return cek()" action="<?= base_url('Setting/MasterRole/input') ?>" method="post" id="inputEvent">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?= base_url('Setting/MasterRole/list_role') ?>" class="btn btn-success btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
