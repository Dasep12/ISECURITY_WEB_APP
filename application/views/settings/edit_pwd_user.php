        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?= base_url('Setting/Pengguna/') ?>">Master</a></li>
                    <li class="breadcrumb-item"><a href="<?= base_url('Setting/Pengguna/') ?>">User</a></li>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <form onsubmit="return cek()" action="<?= base_url('Setting/Pengguna/resetPasword') ?>" method="post" id="inputPlant">
