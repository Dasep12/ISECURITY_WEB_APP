						...
						<form id="form-filter" class="form-horizontal">
							<div class="form-row">
								...
								<div class="form-group col d-flex align-items-end justify-content-end">
									<span class="h1 ff-fugazone title-Admin/Dashboard">Guard Tour Dashboard</span>
								</div>
							</div>
						</form>
					</div>
...
<script>
	...
	var countPlant = <?php count($plant) ?>
	...
	function charTrendPatrolPerPlant(tahun) {
		$.ajax({
			url: "<?= base_url('Admin/Dashboard/trendPatrolBulananPerPlant') ?>",
			method: "POST",
			data: {
				plant_id: '',
				tahun: tahun
	...
	function charTrendPatrolAllD(tahun) {
		...
		$.ajax({
			url: "<?= base_url('Admin/Dashboard/trendPatrolAllPlant') ?>",
			method: "POST",
			data: {
				tahun: tahun
			},
	...
	charTrendPatrolAllD($("#yearFilter").val());
	// tren harian
	Highcharts.chart({
		chart: {
	...
	function chartTrendPatroliHarian(tahun, bulan) {
		$.ajax({
			url: "<?= base_url('Admin/Dashboard/trendPatrolHarian') ?>",
			method: "POST",
			data: {
				tahun: tahun,
				bulan: bulan
	...
	chartTrendPatroliHarian($("#yearFilter").val(), $("#monthFilter").val());
	// end trend
	...
	function charPerformancePatrolAllADM(tahun) {
		...
		$.ajax({
			url: "<?= base_url('Admin/Dashboard/perforamancePatrolBulananPerPlant') ?>",
			method: "POST",
			data: {
				tahun: tahun,
				plant_id: ''
	...
	function charPerformancePatrolAllD(tahun) {
		...
		$.ajax({
			url: "<?= base_url('Admin/Dashboard/perforamancePatrolAllPlant') ?>",
			method: "POST",
			data: {
				tahun: tahun
			},
	...
	charPerformancePatrolAllD($("#yearFilter").val());


	function performanceHarian(tahun, bulan) {
		$.ajax({
			url: "<?= base_url('Admin/Dashboard/perFormancePatrolHarian') ?>",
			method: "POST",
			data: {
				tahun: tahun,
				bulan: bulan
	...
	performanceHarian($("#yearFilter").val(), $("#monthFilter").val());
	Highcharts.chart({
		chart: {
			type: 'line',
	...
	function ajaxTemuanAdm(tahun) {
		$.ajax({
			url: "<?= base_url('Admin/Dashboard/temuanPatrolAllPlant') ?>",
			method: "POST",
			data: {
				tahun: tahun
			},
	...
	function ajaxTemuanReguAdm(tahun, bulan) {
		$.ajax({
			url: "<?= base_url('Admin/Dashboard/temuanPerReguPlant') ?>",
			method: "POST",
			data: {
				tahun: tahun,
				bulan: bulan
	...
	$("#areaFilter, #yearFilter, #monthFilter").change(function(e) {
		...
		charTrendPatrolAllD(year);
		charTrendPatrolPerPlant(year);
		chartTrendPatroliHarian(year, month);
		charPerformancePatrolAllADM(year);
		charPerformancePatrolAllD(year);
		performanceHarian(year, month);
		ajaxTemuanAdm(year);
