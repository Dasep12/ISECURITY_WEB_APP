		...
		<aside class="main-sidebar sidebar-dark-info elevation-4">
		   ...
		   with font-awesome or any other icon font library -->
                        ...
                        <?php if (
							...
							|| $link == 'Mst_Kategori_Object' || $link == 'Mst_Event' || $link == 'Mst_user' || $link == 'FormMenu' || $link == 'Mst_Periode' || $link == 'Mst_Shift' || $link == 'Mst_Periode' || $link == 'Mst_Produksi' || $link == 'Mst_Event_Detail' || $link == 'Mst_user_ga'
						) {
							echo 'menu-open';
						} ?> ">
							<a href="#" class="nav-link
                            <?php if ($link == 'Mst_Site' || $link == 'Mst_Plant' || $link == 'Mst_Zona' || $link == 'Mst_objek' || $link == 'Mst_Kategori_Object' || $link == 'Event' || $link == 'Mst_Role' || $link == 'FormMenu' || $link == 'Mst_Periode' || $link == 'Mst_Shift' || $link == 'Mst_Periode' || $link == 'Mst_Produksi' || $link == 'Mst_Event_Detail' || $link == 'Mst_user_ga') {
								echo 'active';
							} ?>">
						...
						<?php if (($link == 'Laporan_Temuan') || ($link == 'Laporan_Patroli')) {
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="<?= base_url('Laporan_Patroli') ?>" class="nav-link 
								...
								<li class="nav-item">
									<a href="<?= base_url('Laporan_Temuan') ?>" class="nav-link 
