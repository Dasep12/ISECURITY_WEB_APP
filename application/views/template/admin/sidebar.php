            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <?php if (
                            ...
                            || $link == 'Mst_Kategori_Object' || $link == 'Mst_Event' || $link == 'Mst_user' || $link == 'FormMenu' || $link == 'Mst_Periode' || $link == 'Mst_Shift' || $link == 'Mst_Periode' || $link == 'Mst_Produksi' ||  $link == 'Mst_Event_Detail'
                        ) {
                            echo 'menu-open';
                        } ?> ">
                            <a href="#" class="nav-link
                            <?php if ($link == 'Mst_Site' || $link == 'Mst_Plant' || $link == 'Mst_Zona' || $link == 'Mst_objek' || $link == 'Mst_Kategori_Object' || $link == 'Event' || $link == 'Mst_Role' || $link == 'FormMenu' || $link == 'Mst_Periode' || $link == 'Mst_Shift' || $link == 'Mst_Periode' ||  $link == 'Mst_Produksi' ||  $link == 'Mst_Event_Detail') {
                                echo 'active';
                            } ?>">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('Admin/Mst_Site') ?>" class="nav-link
                                ...
                                <li class="nav-item">
                                    <a href=" <?= base_url('Admin/Mst_Plant') ?>" class="nav-link
                                ...
                                <li class="nav-item">
                                    <a href=" <?= base_url('Admin/Mst_Zona') ?>" class="nav-link
                                ...
                                <li class="nav-item">
                                    <a href=" <?= base_url('Admin/Mst_Checkpoint') ?>" class="nav-link
                                ...
                                <li class="nav-item">
                                    <a href=" <?= base_url('Admin/Mst_objek') ?>" class="nav-link
                                ...
                                <li class="nav-item">
                                    <a href=" <?= base_url('Admin/Mst_Kategori_Object') ?>" class="nav-link
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('Admin/Mst_Event') ?>" class="nav-link
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('Admin/Mst_Produksi') ?>" class="nav-link
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('Admin/Mst_user') ?>" class="nav-link
                        ...
                        <?php if (
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('Admin/Mst_Jadwal_Produksi') ?>" class="nav-link
