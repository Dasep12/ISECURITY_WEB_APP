    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-info elevation-4">
            ...
            <a href="<?= base_url('assets') ?>/index3.html" class="brand-link">
                ...
                <label class="brand-text font-bold font-weight-light"><b>GUARD PATROL</b></label>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Astra Daihatsu Motor</a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <?php if (
                            ...
                            || $link == 'Mst_Kategori_Object' || $link == 'Mst_Event' || $link == 'Mst_user' || $link == 'FormMenu' || $link == 'Mst_Periode' || $link == 'Mst_Shift' || $link == 'Mst_Periode' || $link == 'Mst_Jadwal'
                        ) {
                            echo 'menu-open';
                        } ?> ">
                            <a href="#" class="nav-link
                            <?php if ($link == 'Mst_Site' || $link == 'Mst_Plant' || $link == 'Mst_Zona' || $link == 'Mst_objek' || $link == 'Mst_Kategori_Object' || $link == 'Event' || $link == 'Mst_Role' || $link == 'FormMenu' || $link == 'Mst_Periode' || $link == 'Mst_Shift' || $link == 'Mst_Periode' || $link == 'Mst_Jadwal') {
                                echo 'active';
                            } ?>">
