        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('Mst_Event/form_upload_event') ?>">Upload Event</a></li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                ...
                <div class="card mt-2 card4">
                    <div class="card-header text-white">
                        <form method="post" action="<?= base_url('Mst_Event/form_upload_event') ?>" onsubmit="return cekExe()" enctype="multipart/form-data">
                            ...
                            <div class="form-inline mt-2">
                                <a href="<?= base_url('Mst_Event') ?>" class="mr-2 btn btn-success btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                <input type="submit" value="Upload Event" name="view" class="btn btn-info btn-sm"></input>
                            </div>
                        </form>

                        <form action="<?= base_url('Mst_Event/upload') ?>" method="post" enctype="multipart/form-data" class="mt-2">
                            <?php
