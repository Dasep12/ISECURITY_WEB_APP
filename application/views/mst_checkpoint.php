        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card4">
                    ...
                    <div class="card-body">
                        <a href="<?= base_url('Mst_Checkpoint/form_add') ?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Tambah Checkpoint</a>
                        <a href="<?= base_url('Mst_Checkpoint/form_upload') ?>" class="btn btn-sm btn-success"><i class="fa fa-file-excel"></i> Upload Checkpoint</a>

                        <form method="post" action="<?= base_url('Mst_Checkpoint/multipleDelete') ?>">
