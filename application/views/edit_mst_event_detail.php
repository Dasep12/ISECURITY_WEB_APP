        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card4">
                    ...
                    <form onsubmit="return cek()" action="<?= base_url('Mst_Event_Detail/update') ?>" method="post" id="inputEvent">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group ">
                                ...
                                <select class="form-control" name="zone_id" id="zone_id">
                                    ...
                                    <?php foreach ($zona->result() as $znp) : ?>
                            ...
                            <div class="form-group ">
                                ...
                                <select class="form-control" name="check_id" id="check_id">
                                    ...
                                    <?php foreach ($check->result() as $ktr) : ?>
                                        <option value="<?= $ktr->id ?>"><?= $ktr->check_name ?></option>
                                    <?php endforeach ?>
                                </select>
                            ...
                            <div class="form-group ">
                                ...
                                <select class="form-control" name="objek_id" id="objek_id">
                                    <option selected value="<?= $data->objek_id ?>"><?= $data->nama_objek ?></option>
                                    <option value="">Pilih Objek</option>
                                    <?php foreach ($objek->result() as $objk) : ?>
                                        <option value="<?= $objk->id ?>"><?= $objk->nama_objek ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                <label>EVENT</label>
                                <select name="event_id" id="event_id" class="select2 form-control" data-placeholder=" Pilih Event" style="width: 100%;">
                                    <option selected value="<?= $data->event_id ?>"><?= $data->event_name ?></option>
                            ...
                            <a href="<?= base_url('Mst_Event_Detail') ?>" class="btn btn-success btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
...
<script>
    ...
    $("select[name=zone_id").on('change', function() {
        ...
        $.ajax({
            url: "<?= base_url('Mst_Event_Detail/show_checkpoint') ?>",
            method: "POST",
            data: "zone_id=" + id,
            type: 'json',
            cache: false,
    ...
    $("select[name=check_id").on('change', function() {
        ...
        $.ajax({
            url: "<?= base_url('Mst_Event_Detail/show_objek') ?>",
            method: "POST",
            data: "check_id=" + id,
            type: 'json',
            cache: false,
