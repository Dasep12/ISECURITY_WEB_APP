        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card4">
                    ...
                    <form onsubmit="return cek()" action="<?= base_url('Mst_Checkpoint/update') ?>" method="post" id="updateCheckpoint">
                        <input type="hidden" name="id" value="<?= $data->checkpoint_id ?>">
                        <div class="card-body">
                            ...
                            <div id="list_zone">
                                ...
                                <select class="form-control" name="zone_id" id="zone_id">
                                    <?php foreach ($zone->result() as $znp) :
                                        if (strval($znp->zone_id) == strval($zona_id)) { ?>
                                            <option selected value="<?= $data->admisecsgp_mstzone_zone_id ?>"><?= $data->zone_name ?></option>
                                        <?php } else { ?>
