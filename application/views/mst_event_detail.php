        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card4">
                    ...
                    <div class="card-body">
                        <a href="<?= base_url('Mst_Event_Detail/form_add') ?>" class="btn btn-sm btn-primary">
                            <i class="fa fa-plus"></i> Tambah Event Detail</a>
                        <a href="<?= base_url('Mst_Event_Detail/form_upload_event_detail') ?>" class="btn btn-sm btn-success">
                            <i class="fa fa-file-excel"></i> Upload Event Detail</a>

                        <form method="post" action="<?= base_url('Mst_Event_Detail/multipleDelete') ?>">
                                    ...
                                    foreach ($event->result() as $zn) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= base_url('Mst_Event_Detail/hapus/' . $zn->id) ?>" onclick="return confirm('Yakin Hapus ?')" class='text-danger' title="hapus data"><i class="fa fa-trash"></i></a>
                                                ...
                                                <a href="<?= base_url('Mst_Event_Detail/edit?event_id=' . $zn->id) ?>&zona_id=<?= $zn->zona_id ?>&plant_id=<?= $zn->plant_id ?>&check_id=<?= $zn->check_id ?>&objek_id=<?= $zn->objek_id ?>" class='text-success ml-2 ' title="edit data"><i class="fa fa-edit"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </tbody>
