        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?= base_url('Mst_Jadwal_Patroli') ?>">Master</a></li>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card4">
                    ...
                    <form action="<?= base_url('Mst_Jadwal_Patroli/form_rubah_jadwal_petugas') ?>" method="post" id="updateJadwal">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-3">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input value="<?= $session_date ?>" placeholder="<?= date('Y-m-d') ?>" type="text" id="tgl1" name="date" class="form-control">
                                    </div>
                                </div>

                            </div>

                            <a href="<?= base_url('Mst_Jadwal_Patroli') ?>" class="btn btn-success btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
...
<script>
    function showuserdetail(idPlant, idUser, dataShift, date, shiftId, name, npk) {
        $.ajax({
            type: "post",
            url: "<?= base_url('Mst_Jadwal_Patroli/load_data_petugas'); ?>",
