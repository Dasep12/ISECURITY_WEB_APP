                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <!-- <fieldset class="form-group border p-3">
                                        <legend class="w-auto px-2 ">ROLE APLIKASI</legend>
                                        <div class="form-group ">
                                            <div class="custom-control custom-checkbox">
                                                <input name="app_guardtour" class="custom-control-input" type="checkbox" id="customCheckbox1" value="1">
                                                <label for="customCheckbox1" class="custom-control-label">SECURITY GUARD TOUR</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input name="app_vms" class="custom-control-input" type="checkbox" id="customCheckbox2" value="1">
                                                <label for="customCheckbox2" class="custom-control-label">VISITOR MANAGEMENT SYSTEM</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="customCheckbox3" value="1">
                                                <label for="customCheckbox3" class="custom-control-label">SECURITY OPERATIONAL</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="customCheckbox4" value="1">
                                                <label for="customCheckbox4" class="custom-control-label">SECURITY RISK SURVEY</label>
                                            </div>
                                        </div>
                                    </fieldset> -->
                                </div>
