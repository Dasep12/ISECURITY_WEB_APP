...
class Mst_Jadwal_Produksi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view("mst_jadwal_produksi", $data);
    ...
    public function form_rubah_jadwal_produksi()
    {
        ...
        // 
        $this->load->view("template/sidebar", $data);
        $this->load->view("form_edit_jadwal_produksi", $data);
        $this->load->view("template/footer");
    }
    ...
    public function load_data_produksi()
    {
        ...
        $this->load->view("ajax/detail_produksi", $data);
    }
    ...
    public function form_revisi_upload_jadwal()
    {
        ...
        $this->load->view("template/sidebar", $data);
        $this->load->view("form_revisi_upload_jadwal", $data);
        $this->load->view("template/footer");
    }
    ...
    public function updateZonaStatus()
    {
        $id = $this->input->post("id");
        $stat = $this->input->post("stat");
        $type = $this->input->post("type");
        $idProduksi = $stat == 1 ? 'PRODUKSI' : 'NON-PRODUKSI';
        ...
        if ($type == "zona") {
            ...
            $prd = $this->M_patrol->ambilData("admisecsgp_mstproduction", ['name' => $idProduksi])->row();
            $data = [
                'admisecsgp_mstproduction_produksi_id'  => $prd->produksi_id,
                'updated_by'      => $this->session->userdata('id_token'),
                'updated_at'      => date('Y-m-d H:i:s')
            ];
        }
